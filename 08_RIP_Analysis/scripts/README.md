...
BED sorting, merging, and RIP–TE intersections
...
Sort RIP-positive regions.

Merge overlapping or adjacent RIP-positive windows.

Generate merged RIP regions (LRARs).

Intersect RIP/LRAR regions with EarlGrey TE annotations.
